...
function HomePage(props) {
    ...
    const master = useSelector((state) => state.masterState ? state.masterState.masterData : null);
    if (master == undefined || (master === null || master === void 0 ? void 0 : master.length) == 0) {
    ...
    //}
    //}
    return React.createElement(TheLayout, null);
}
