...
import { nameValueEntity } from "./realTimeStatistics";
...
const UploadStatus = (props: UploadStatusProps) => {
    ...
    let chartData: nameValueEntity[] = [
        { name: "Success", y: props.success },
        { name: "Failure", y: props.failure },
        { name: "Duplicate", y: props.duplicate }
    ];
    ...
    const options = {
        ...
        title: {
            text: '<span class="chartLabel">Upload Status</span>',
            y: 15,
            x: -20,
        },
        subtitle: {
            text: '<p style="fill:#f26525">' + props.total + '</p><br /><span>Total</span>',
            align: 'center',
            verticalAlign: 'middle',
            style: {
                color: '#666666',
